...
public class CFHttpClient {
    ...
    // "http://192.168.191.1:8080/niudan-server/coreServlet";
//10.165.108.243测试
    //101.200.85.188:8080正式
                    ...
                    if (200 == code) {
                        ...
                        switch (msg.what) {
                            ...
                            case 9001:
                                ...
                                break;
                            case 7003:
                                handler.sendMessage(send7003(msg, new CFMessage(
                                        httpMsg, sb, null)));
                                break;
                            case 9003:
                            ...
                            case 9019:
                                ...
                                break;
                            case 7001:
                                handler.sendMessage(send7001(msg, new CFMessage(
                                        httpMsg, sb, null)));
                                break;
                            case 7002:
                                handler.sendMessage(send7002(msg, new CFMessage(
                                        httpMsg, sb, null)));
                                break;

                            case 9020:
                                handler.sendMessage(send9020(msg, new CFMessage(
                                        httpMsg, sb, null)));
                                break;
                            case 9021:
                                handler.sendMessage(send9021(msg, new CFMessage(
                                        httpMsg, sb, null)));
                                break;
                            case 9022:
                                handler.sendMessage(send9022(msg, new CFMessage(
                                        httpMsg, sb, null)));
                                break;
                            case 9023:
                                handler.sendMessage(send9023(msg, new CFMessage(
                                        httpMsg, sb, null)));
                                break;
                        }
                        isOne = true;
    ...
    // 登陆注册端口7003
    private Message send7003(Message msg, CFMessage cfm) throws Exception {
        JSONObject jo = new JSONObject(cfm.getSb().toString());
        msg.arg1 = jo.getInt("result");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("user",
    ...
    // 获取版本7001
    private Message send7001(Message msg, CFMessage cfm) throws Exception {
        JSONObject jo = new JSONObject(cfm.getSb().toString());
        msg.arg1 = jo.getInt("result");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("version",
    ...
    // 获取商家端口7002
    private Message send7002(Message msg, CFMessage cfm) throws Exception {
        JSONObject jo = new JSONObject(cfm.getSb().toString());
        msg.arg1 = jo.getInt("result");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("customerlist",
                JSON.parseArray(jo.getString("customerlist"), Customer.class));
        map.put("data",
                JSON.parseObject(jo.getString("data"), CustomerTypeData.class));
        cfm.setObject(map);
        msg.obj = cfm;
        return msg;
    }
    ...
    // 获取商家端口
    private Message send9020(Message msg, CFMessage cfm) throws Exception {
        JSONObject jo = new JSONObject(cfm.getSb().toString());
        msg.arg1 = jo.getInt("result");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("smstatistics",
                JSON.parseObject(jo.getString("smstatistics"), SMStatistics.class));
    ...
    // 获取商家端口列表9021
    private Message send9021(Message msg, CFMessage cfm) throws Exception {
        JSONObject jo = new JSONObject(cfm.getSb().toString());
        msg.arg1 = jo.getInt("result");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("datalist",
                JSON.parseArray(jo.getString("datalist"), SMCustomerReward.class));
        cfm.setObject(map);
        msg.obj = cfm;
        return msg;
    }
    // 获取会员端口列表9022
    private Message send9022(Message msg, CFMessage cfm) throws Exception {
        JSONObject jo = new JSONObject(cfm.getSb().toString());
        msg.arg1 = jo.getInt("result");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("datalist",
                JSON.parseArray(jo.getString("datalist"), SMUserReward.class));
        cfm.setObject(map);
        msg.obj = cfm;
        return msg;
    }
    // 获取商家端口列表9023
    // 获取商家端口
    private Message send9023(Message msg, CFMessage cfm) throws Exception {
        JSONObject jo = new JSONObject(cfm.getSb().toString());
        msg.arg1 = jo.getInt("result");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("data",
                JSON.parseObject(jo.getString("data"), SMCustomerReward.class));
