...
public class Region_Adapter extends BaseAdapter implements OnClickListener {
	//
	private ArrayList<RegionInfo> datalist;
	private Context mContext;
	private Handler handler;

	public Region_Adapter(Context mContext, ArrayList<RegionInfo> mqlist,
			Handler handler) {
	...
	public void setNewListInfo(ArrayList<RegionInfo> mqlist) {
		this.datalist = mqlist;
	}
